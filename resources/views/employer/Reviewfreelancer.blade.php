...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="card-body">
    <form method="POST" action="{{ route('submitreviewFreelancer') }}">
    @csrf
    ...
    <input type="hidden" name="freelancer_user_id" value="{{ $freelancer->user_id }}">
    
    
 
    <!-- Submit Button -->
    <button type="submit" style="background-color: #00D9A5; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; display: block; margin: 0 auto;">Submit Review</button>
</form>
