    ...
    <div class="container mt-5">
        ...
        <form action="{{ url('postjob') }}" method="post">
            ...
            <select class="form-control" id="category" name="category" required>
                ...
                <option value="NewSecurityValue">NewSecurityValue</option>
                <option value="Application Security">Application Security</option>
                 <option value="Cloud Security">Cloud Security</option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="budget_range" name="budget_range" required>
            </div>
            ...
            <button type="submit" style="background-color: #00D9A5; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; display: block; margin: 0 auto;">Post Job</button>
        </form>
    </div>
