...
<body>
  ...
  <div class="container mt-5">
    <h1 class="mb-4">Set Up Your Employer Profile</h1>
    @if(session('success'))
    ...
    <form method="post" action="{{ route('save.profile') }}" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="years_in_industry" name="years_in_industry" required>
      </div>
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="freelancers_collaborated" name="freelancers_collaborated" required>
      </div>
