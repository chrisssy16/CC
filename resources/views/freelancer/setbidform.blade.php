...
<body>
  ...
  <div class="container mt-5">
        ...
        <form action="{{ route('submit.bid', ['job_id' => $job_id]) }}" method="post">
            @csrf
            ...
            <button type="submit" style="background-color: #00D9A5;; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; display: block; margin: 0 auto;">Submit Bid</button>
        </form>
    </div>
