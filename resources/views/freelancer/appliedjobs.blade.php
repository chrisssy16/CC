...
<body>
  ...
  <div class="container">
        ...
        @forelse ($freelancerJobs as $job)
            <div>
                <p>{{ $job->job_title }} by {{ $job->employer->company_name }}</p>
                <p>Bid Amount: ${{ $job->bid->budget_range }}</p>

                
@if ($job->status == 'Pending')
    <!--<a href="{{ route('freelancer.chat', ['job' => $job->id]) }}" class="btn btn-primary">Open Chat</a>-->
